...
\textcolor{red}{\textbf{Message from Chrystopher:}\\
A security issue arises (especially in a decentralized or distributed setting):  What if sender(msg), receiver(msg), or msg is faked? There should be something about  such security issues mentioned, but perhaps in the requirements section.}
