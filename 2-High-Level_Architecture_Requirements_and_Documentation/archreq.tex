...
\begin{minipage}[t]{0.37\columnwidth}Receive a part of his salary in Sardex credits (for example bonus, benefits, etc.). Find Sardex companies where she can spend her credits, manage her account, and pay in the  \end{minipage}
\tabularnewline
\tabularnewline
